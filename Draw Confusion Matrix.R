...
## MCC
mcc_func <- function (actual, predicted)
{
...
# Insurance
my_mcc <- mcc_func(actual = predicted_local$DIABETES, predicted = predicted_local$PREDICTED_CLASS)
...
draw_confusion_matrix <- function(cm) {
  ...
  # adding MCC
  text(90, 35, "MCC", cex=1.4, font=2)
  text(90, 20, round(as.numeric(my_mcc), 3), cex=1.4)
  
  # adding AUC
  text(50, 35, "AUC", cex=1.4, font=2)
  text(50, 20, round(as.numeric(0.75), 3), cex=1.4) # TBD
